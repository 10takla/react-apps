...
const other = {
    ...
    Английский: { level: "A2 (Elementary)", stars: 2, en: "English", isId: true }
}
...
import CleanCode from 'src/resume copy/shared/assets/imgs/Чистый код.webp';
import RustAtomics from 'src/resume copy/shared/assets/imgs/Rust Atomics and Locks.jpg';
