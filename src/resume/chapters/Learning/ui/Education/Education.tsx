...
import TimeLine from 'resume/shared/ui/TimeLine/TimeLine';
import { educs } from 'resume/shared/const/info';
import { langContext } from 'resume/shared/ui/ToggleLanguage/ToggleLanguage';
...
const Education = (props: EducationProps, ref: ForwardedRef<ElRef>) => {
    ...
    return (
        ...
        >
            {educs.map((u, i) => (
                <VStack className={cls.place} key={i}>
                    ...
                    <TimeLine className={cls.timeLine} timeProps={{className: cls.time}} time={u.time} />
                </VStack>
            ))}
        </VStack>
    )
